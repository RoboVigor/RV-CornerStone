...
void Protocol_Pack(Protocol_Type *Protocol) {
    ...
    case Protocol_Data_Id_Robot: {
        ...
        dataLength = Protocol_Pack_Length_0301_Header + Protocol->robotInteractiveData[0].length;
    } break;

    default: {
        // Vision Interactive Data
        dataLength = Protocol_Pack_Length_0401;
    } break;
    }
    ...
    case Protocol_Data_Id_Robot: {
        ...
        // Robot Interactive Data
        for (i = 0; i < Protocol->robotInteractiveData[0].length; i++) {
...
void Protocol_Load(Protocol_Type *Protocol) {
    ...
    const unsigned char CRC8_TAB[256] = {
        ,
