...
void CAN1_RX0_IRQHandler(void) {
    ...
    case 0x201:
        Motor_Update(&Motor_SumsungLB, position, angle);
        break;

    case 0x202:
        Motor_Update(&Motor_SumsungRB, position, angle);
        break;

    case 0x203:
        Motor_Update(&Motor_SumsungRF, position, angle);
        break;

    case 0x204:
        Motor_Update(&Motor_SumsungLF, position, angle);
        break;
