...
__HANDLE_EXT Stabilizer_Type Pitch_Angle, Yaw_Angle;
...
//功率
__HANDLE_EXT Ramp_Lowpass_Type Ramp_Power, Lowpass_Power;
__HANDLE_EXT ChassisStatus_Type ChassisStatus;
