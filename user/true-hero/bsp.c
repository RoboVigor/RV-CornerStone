...
void BSP_Init(void) {
    ...
    // Servo
    // BSP_PWM_Set_Port(&PWM_Magazine_ServoL, PWM_PORT_PD12);
    // BSP_PWM_Init(&PWM_Magazine_ServoL, 9000, 200, TIM_OCPolarity_Low);
    // BSP_PWM_Set_Port(&PWM_Magazine_ServoR, PWM_PORT_PD13);
    // BSP_PWM_Init(&PWM_Magazine_ServoR, 9000, 200, TIM_OCPolarity_Low);
}