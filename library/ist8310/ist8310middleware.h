...
extern void    ist8310_IIC_Write(I2C_TypeDef *I2Cx, uint16_t DevAddress, uint16_t MemAddress, uint8_t Data);
extern uint8_t ist8310_IIC_Read(I2C_TypeDef *I2Cx, uint16_t DevAddress, uint16_t MemAddress);
